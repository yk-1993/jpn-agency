        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-2 space-y-6">
            <div className="aspect-video rounded-lg overflow-hidden">
              <img
                src={event.image_url || 'https://images.pexels.com/photos/3800541/pexels-photo-3800541.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'}
                alt={event.name}
            ...
            <div>
              <h1 className="text-3xl font-bold mb-4" data-language-en={event.name} data-language-zh={event.name_zh || event.name}>
                {event.name}
              </h1>
              ...
              <div className="prose max-w-none" data-language-en={event.description} data-language-zh={event.description_zh || event.description}>
